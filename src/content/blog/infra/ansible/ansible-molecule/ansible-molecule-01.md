...
nextPost: 'https://juehara-crypto.github.io/blog/infra/ansible/ansible-molecule/ansible-molecule-02/'
relatedSeries: ''
---
...
**[ドリフトシリーズ](https://qiita.com/juehara-crypto/items/2a375a2c0fca3a8df0ca)** で扱った「手動変更が加わった環境」とは対照的な状態です。**[ドリフトシリーズ](https://qiita.com/juehara-crypto/items/2a375a2c0fca3a8df0ca)** では、Ansibleの管理外で状態が変化した環境にPlaybookを適用したときに何が起きるかを扱いました。Moleculeのcreateフェーズが用意するのは、そうした管理外の変化が一切ない、まっさらな環境です。テストのたびにこの状態から始めることで、「今回のテスト結果が、前回のテストや管理外の変化の影響を受けていない」ことが担保されます。
...
次回は、「構造として理解した」を「実際に動かして確認する」に進めます。**[冪等性シリーズ](https://qiita.com/juehara-crypto/items/d77fa93e82ea4a33ef4f)** で作成したPlaybookをMoleculeでテストする構成を実機で確認し、1回目と2回目の実行で何が確認されているかを見ていきます。

**[次回：第2回：冪等性テストを自動化する](https://juehara-crypto.github.io/blog/infra/ansible/ansible-molecule/ansible-molecule-02/)**

---

📑 連載の移動　**[前の記事：【Molecule編】 第0回](https://juehara-crypto.github.io/blog/infra/ansible/ansible-molecule/ansible-molecule-00/)　｜　[次の記事：【Molecule編】 第2回](https://juehara-crypto.github.io/blog/infra/ansible/ansible-molecule/ansible-molecule-02/)**
