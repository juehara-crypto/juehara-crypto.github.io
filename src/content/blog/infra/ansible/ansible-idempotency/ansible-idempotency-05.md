...
**次回：第6回：なぜlineinfileは"安全そうに見えて危険"なのか ※近日公開予定**
...
📑 連載の移動　**[前の記事：第4回](https://juehara-crypto.github.io/blog/infra/ansible/ansible-idempotency/ansible-idempotency-04/)　｜　次の記事：第6回**
...
| **[第5](https://juehara-crypto.github.io/blog/infra/ansible/ansible-idempotency/ansible-idempotency-05/)**回                                                                                                        | なぜサービス制御は再起動ループを生むのか            | service/systemd/handler の notify 連鎖を通して、「変更検知」がどのように状態遷移を引き起こすのかを理解する。reload/restart の違いも整理する。       |
