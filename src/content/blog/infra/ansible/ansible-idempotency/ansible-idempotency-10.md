...
冪等性シリーズで整理した「壊れない設計」を前提に、次シリーズは**Ansibleが実行されていない時間に起きる構成ドリフト**を扱います。Playbookを正しく設計して冪等性を保っていても、Ansibleが実行されていない時間に起きる変化には対応できません。
...
**[次回：【構成ドリフト編】第0回：なぜAnsibleで管理しているのにサーバはずれていくのか](https://juehara-crypto.github.io/blog/infra/ansible/ansible-drift/ansible-drift-00/)**
